...
Регистры, в которых хранятся эти ключи, доступны на уровнях EL1 и выше. Процесс формирования PAC показан на рис. 4.6
![](https://github.com/IgorKurylev/arm_rop_report/blob/master/pics/PAC.png)
Рис. 4.6 формирование PAC
